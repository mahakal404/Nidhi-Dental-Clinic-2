...
const Navbar = () => {
  ...
  return (
    <header className="fixed w-full z-50">
      <div className="bg-blue-600 text-white text-xs md:text-sm py-2 text-center font-semibold tracking-wide">
        🎉 Special Offer: Free Dental Checkup in March of Every Year! Book your slot today.
      </div>
          ...
          <div className="flex-shrink-0 flex items-center">
            <a href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity duration-300">
              <img 
                ...
                className="h-10 w-10 md:h-14 md:w-14 object-contain rounded-full"
              />
              <span className="text-xl md:text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-800 via-blue-500 to-cyan-500 bg-[length:200%_auto] tracking-tight animate-[gradient_3s_linear_infinite] hidden sm:block">
                Nidhi Dental Clinic
              </span>
            </a>
          </div>
